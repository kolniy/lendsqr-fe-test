                    ...
                    <div className="user-info__content">
                        <div className="user-profile-display">
                            <div className="avatar-display">
                                <img src={user?.profile.avatar} alt='...' className='profile-avatar' />
                            </div>
                        ...
                        <div className="user-actions-container">
                            <div onClick={() => updateActiveTab(1)} className={`tab-button ${activeTab === 1 && "active-tab"}`}>General Details</div>
                            <div onClick={() => updateActiveTab(2)} className={`tab-button ${activeTab === 2 && "active-tab"}`}>Documents</div>
                            <div onClick={() => updateActiveTab(3)} className={`tab-button ${activeTab === 3 && "active-tab"}`}>Bank Details</div>
                            <div onClick={() => updateActiveTab(4)} className={`tab-button ${activeTab === 4 && "active-tab"}`}>Loans</div>
                            <div onClick={() => updateActiveTab(5)} className={`tab-button ${activeTab === 5 && "active-tab"}`}>Savings</div>
                            <div onClick={() => updateActiveTab(6)} className={`tab-button ${activeTab === 6 && "active-tab"}`}>App and System</div>
                        </div>
                    </div>
